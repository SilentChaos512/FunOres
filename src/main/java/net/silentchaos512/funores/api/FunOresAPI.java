...
public class FunOresAPI {
    ...
    /**
     * Adds an alloy smelter recipe. Don't forget to set stack sizes on everything! And copy the
     * item stacks before you modify them...
     * <p>
     * Inputs can be any mix of AlloySmelterRecipeObjects, Strings, or ItemStacks. See
     * AlloySmelterRecipeObject for details on how to format the strings, or FunOres.java for
     * examples.
     *
     * @param output     The recipe result. You must set the stack size!
     * @param cookTime   The time in ticks to smelt the recipe.
     * @param experience The experience awarded for smelting.
     * @param inputs     The ingredients (see above for details).
     */
    public static void addAlloySmelterRecipe(ItemStack output, int cookTime, float experience, Object... inputs) {
     ...
     * @param outputCount The stack size of the result.
     * @param cookTime    The time in ticks to smelt the recipe.
     * @param experience  The experience awarded for smelting.
     * @param inputs      The ingredients (see previous method for details).
     */
     ...
     *
     * @param output     The result of drying the input.
     * @param dryTime    The base drying time.
     * @param experience The experience resulting from the recipe.
     * @param input      Can be an ItemStack or a String (ore dictionary name).
     */
    public static void addDryingRackRecipe(ItemStack output, int dryTime, float experience, Object input) {
     ...
     *
     * @param plate The resulting item.
